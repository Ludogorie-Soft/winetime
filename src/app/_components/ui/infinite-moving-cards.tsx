  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[220px] max-w-full relative rounded-2xl border flex-shrink-0 border-slate-700 px-2 py-2"
            style={{
            ...
            <blockquote>
              <div className="relative z-20 flex flex-row justify-center items-center">
                <span className="flex flex-col gap-1">
                  <span className=" text-sm leading-[1.6] text-black font-normal">{item.name}</span>
                  {item.title && (
