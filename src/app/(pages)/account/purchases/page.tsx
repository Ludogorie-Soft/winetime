    ...
    <div>
      ...
      <div>
        {user?.purchases?.length || 0 > 0 ? (
                  ...
                  {typeof purchase === 'string' ? (
                    ...
                    <Link href={`/products/${purchase.slug}`} className={classes.item}>
                      <div className={classes.mediaWrapper}>
                        ...
                        {purchase.meta.image && (
                          <Image
                            src={`/mdeia/${purchase.meta.image.filename as string}`}
                            alt={purchase.meta.alt}
                            fill
                      ...
                      <div className={classes.itemDetails}>
                        ...
                        <p className={classes.purchasedDate}>{`Поръчан на: ${formatDateTime(
                          purchase.createdAt,
                        )}`}</p>
                      </div>
                    </Link>
          ...
          <div className={classes.noPurchases}>Нямате предишни поръчки.</div>
        )}
      </div>
    </div>
  )
